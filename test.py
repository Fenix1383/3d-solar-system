...
all_cels = [sun, earth]
renderer = Renderer(all_cels)

print(renderer.vector_to_rotation(renderer.rotation_to_vector(
    renderer.vector_to_rotation(renderer.rotation_to_vector(([0, math.pi]))))))
print(str(renderer.rotation_to_vector([0, math.pi])))